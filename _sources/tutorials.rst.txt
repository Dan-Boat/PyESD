...
`Notebook that shows the predictand and predictors data structure <https://nbviewer.org/github/Dan-Boat/PyESD/blob/main/examples/tutorials/data_structure.ipynb>`_
...
`Predictors selection methods example <https://nbviewer.org/github/Dan-Boat/PyESD/blob/main/examples/tutorials/Predictor_selection.ipynb>`_
...
`Using large-scale teleconnections as predictors example <>`_
...
`model selection experiment example <>`_

Coupling ESD to GCMs for future prediction
--------------------------------------------

`making future prediction example <>`_


Visualization and Data Analysis 
--------------------------------

`example of some cool visualization pyESD can do <>`_
