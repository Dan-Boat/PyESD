...
ERA5Data = Dataset('ERA5', {
    ...
    'z250':os.path.join(era5_datadir, 'z500_monthly.nc'),
    'z500':os.path.join(era5_datadir, 'z500_monthly.nc'),
    'z700':os.path.join(era5_datadir, 'z500_monthly.nc'),
    'z850':os.path.join(era5_datadir, 'z850_monthly.nc'),
    'z1000':os.path.join(era5_datadir, 'z500_monthly.nc'),
    ...
    't250':os.path.join(era5_datadir, 't850_monthly.nc'),
    't500':os.path.join(era5_datadir, 't850_monthly.nc'),
    't700':os.path.join(era5_datadir, 't850_monthly.nc'),
    't850':os.path.join(era5_datadir, 't850_monthly.nc'),
    't1000':os.path.join(era5_datadir, 't500_monthly.nc'),
    'r250':os.path.join(era5_datadir, 'r850_monthly.nc'),
    'r500':os.path.join(era5_datadir, 'r500_monthly.nc'),
    'r700':os.path.join(era5_datadir, 'r500_monthly.nc'),
    'r850':os.path.join(era5_datadir, 'r500_monthly.nc'),
    'r1000':os.path.join(era5_datadir, 'r500_monthly.nc'),
    ...
    'u250':os.path.join(era5_datadir, 'u850_monthly.nc'),
    'u500':os.path.join(era5_datadir, 'u500_monthly.nc'),
    'u700':os.path.join(era5_datadir, 'u500_monthly.nc'),
    'u850':os.path.join(era5_datadir, 'u500_monthly.nc'),
    'u1000':os.path.join(era5_datadir, 'u500_monthly.nc'),
    'v250':os.path.join(era5_datadir, 'v850_monthly.nc'),
    'v500':os.path.join(era5_datadir, 'v500_monthly.nc'),
    'v700':os.path.join(era5_datadir, 'v500_monthly.nc'),
    'v850':os.path.join(era5_datadir, 'v500_monthly.nc'),
    'v1000':os.path.join(era5_datadir, 'v500_monthly.nc'),
