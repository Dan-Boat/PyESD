...
path_to_data = "C:/Users/dboateng/Desktop/Datasets/Station/Ghana/Update_datasets/preprocessed"
...
def write_data():
    ...
    for csv in p(path_to_data).glob(glob_name):
        ...
        df.to_csv(os.path.join(path_to_processed_monthly, save_name + ".csv"), index=False, header=False)
