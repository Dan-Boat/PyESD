...
CMIP6_RCP26_R1 = Dataset('CMIP5_RCP26_R1', {
    't2m':os.path.join(cmip6_26_datadir, 't2m_monthly.nc'),
    'msl':os.path.join(cmip6_26_datadir, 'msl_monthly.nc'),
    'u10':os.path.join(cmip6_26_datadir, 'u10_monthly.nc'),
    'v10':os.path.join(cmip6_26_datadir, 'v10_monthly.nc'),
    'z250':os.path.join(cmip6_26_datadir, 'z250_monthly.nc'),
    'z500':os.path.join(cmip6_26_datadir, 'z500_monthly.nc'),
    'z700':os.path.join(cmip6_26_datadir, 'z700_monthly.nc'),
    'z850':os.path.join(cmip6_26_datadir, 'z850_monthly.nc'),
    'z1000':os.path.join(cmip6_26_datadir, 'z1000_monthly.nc'),
    'tp':os.path.join(cmip6_26_datadir, 'tp_monthly.nc'),
    't250':os.path.join(cmip6_26_datadir, 't250_monthly.nc'),
    't500':os.path.join(cmip6_26_datadir, 't500_monthly.nc'),
    't700':os.path.join(cmip6_26_datadir, 't700_monthly.nc'),
    't850':os.path.join(cmip6_26_datadir, 't850_monthly.nc'),
    't1000':os.path.join(cmip6_26_datadir, 't1000_monthly.nc'),
    'r250':os.path.join(cmip6_26_datadir, 'r250_monthly.nc'),
    'r500':os.path.join(cmip6_26_datadir, 'r500_monthly.nc'),
    'r700':os.path.join(cmip6_26_datadir, 'r700_monthly.nc'),
    'r850':os.path.join(cmip6_26_datadir, 'r850_monthly.nc'),
    'r1000':os.path.join(cmip6_26_datadir, 'r1000_monthly.nc'),
    'u250':os.path.join(cmip6_26_datadir, 'u250_monthly.nc'),
    'u500':os.path.join(cmip6_26_datadir, 'u500_monthly.nc'),
    'u700':os.path.join(cmip6_26_datadir, 'u700_monthly.nc'),
    'u850':os.path.join(cmip6_26_datadir, 'u850_monthly.nc'),
    'u1000':os.path.join(cmip6_26_datadir, 'u1000_monthly.nc'),
    'v250':os.path.join(cmip6_26_datadir, 'v250_monthly.nc'),
    'v500':os.path.join(cmip6_26_datadir, 'v500_monthly.nc'),
    'v700':os.path.join(cmip6_26_datadir, 'v700_monthly.nc'),
    'v850':os.path.join(cmip6_26_datadir, 'v850_monthly.nc'),
    'v1000':os.path.join(cmip6_26_datadir, 'v1000_monthly.nc'),
    'dtd250':os.path.join(cmip6_26_datadir, 'dtd250_monthly.nc'), 
    'dtd500':os.path.join(cmip6_26_datadir, 'dtd500_monthly.nc'),
    'dtd700':os.path.join(cmip6_26_datadir, 'dtd700_monthly.nc'),
    'dtd850':os.path.join(cmip6_26_datadir, 'dtd850_monthly.nc'),
    'dtd1000':os.path.join(cmip6_26_datadir, 'dtd1000_monthly.nc')
    }, domain_name= "Africa")
...
CMIP6_RCP45_R1 = Dataset('CMIP5_RCP45_R1', {
    't2m':os.path.join(cmip6_45_datadir, 't2m_monthly.nc'),
    'msl':os.path.join(cmip6_45_datadir, 'msl_monthly.nc'),
    'u10':os.path.join(cmip6_45_datadir, 'u10_monthly.nc'),
    'v10':os.path.join(cmip6_45_datadir, 'v10_monthly.nc'),
    'z250':os.path.join(cmip6_45_datadir, 'z250_monthly.nc'),
    'z500':os.path.join(cmip6_45_datadir, 'z500_monthly.nc'),
    'z700':os.path.join(cmip6_45_datadir, 'z700_monthly.nc'),
    'z850':os.path.join(cmip6_45_datadir, 'z850_monthly.nc'),
    'z1000':os.path.join(cmip6_45_datadir, 'z1000_monthly.nc'),
    'tp':os.path.join(cmip6_45_datadir, 'tp_monthly.nc'),
    't250':os.path.join(cmip6_45_datadir, 't250_monthly.nc'),
    't500':os.path.join(cmip6_45_datadir, 't500_monthly.nc'),
    't700':os.path.join(cmip6_45_datadir, 't700_monthly.nc'),
    't850':os.path.join(cmip6_45_datadir, 't850_monthly.nc'),
    't1000':os.path.join(cmip6_45_datadir, 't1000_monthly.nc'),
    'r250':os.path.join(cmip6_45_datadir, 'r250_monthly.nc'),
    'r500':os.path.join(cmip6_45_datadir, 'r500_monthly.nc'),
    'r700':os.path.join(cmip6_45_datadir, 'r700_monthly.nc'),
    'r850':os.path.join(cmip6_45_datadir, 'r850_monthly.nc'),
    'r1000':os.path.join(cmip6_45_datadir, 'r1000_monthly.nc'),
    'u250':os.path.join(cmip6_45_datadir, 'u250_monthly.nc'),
    'u500':os.path.join(cmip6_45_datadir, 'u500_monthly.nc'),
    'u700':os.path.join(cmip6_45_datadir, 'u700_monthly.nc'),
    'u850':os.path.join(cmip6_45_datadir, 'u850_monthly.nc'),
    'u1000':os.path.join(cmip6_45_datadir, 'u1000_monthly.nc'),
    'v250':os.path.join(cmip6_45_datadir, 'v250_monthly.nc'),
    'v500':os.path.join(cmip6_45_datadir, 'v500_monthly.nc'),
    'v700':os.path.join(cmip6_45_datadir, 'v700_monthly.nc'),
    'v850':os.path.join(cmip6_45_datadir, 'v850_monthly.nc'),
    'v1000':os.path.join(cmip6_45_datadir, 'v1000_monthly.nc'),
    'dtd250':os.path.join(cmip6_45_datadir, 'dtd250_monthly.nc'), 
    'dtd500':os.path.join(cmip6_45_datadir, 'dtd500_monthly.nc'),
    'dtd700':os.path.join(cmip6_45_datadir, 'dtd700_monthly.nc'),
    'dtd850':os.path.join(cmip6_45_datadir, 'dtd850_monthly.nc'),
    'dtd1000':os.path.join(cmip6_45_datadir, 'dtd1000_monthly.nc')
    }, domain_name= "Africa")
...
CMIP6_RCP85_R1 = Dataset('CMIP5_RCP85_R1', {
    't2m':os.path.join(cmip6_85_datadir, 't2m_monthly.nc'),
    'msl':os.path.join(cmip6_85_datadir, 'msl_monthly.nc'),
    'u10':os.path.join(cmip6_85_datadir, 'u10_monthly.nc'),
    'v10':os.path.join(cmip6_85_datadir, 'v10_monthly.nc'),
    'z250':os.path.join(cmip6_85_datadir, 'z250_monthly.nc'),
    'z500':os.path.join(cmip6_85_datadir, 'z500_monthly.nc'),
    'z700':os.path.join(cmip6_85_datadir, 'z700_monthly.nc'),
    'z850':os.path.join(cmip6_85_datadir, 'z850_monthly.nc'),
    'z1000':os.path.join(cmip6_85_datadir, 'z1000_monthly.nc'),
    'tp':os.path.join(cmip6_85_datadir, 'tp_monthly.nc'),
    't250':os.path.join(cmip6_85_datadir, 't250_monthly.nc'),
    't500':os.path.join(cmip6_85_datadir, 't500_monthly.nc'),
    't700':os.path.join(cmip6_85_datadir, 't700_monthly.nc'),
    't850':os.path.join(cmip6_85_datadir, 't850_monthly.nc'),
    't1000':os.path.join(cmip6_85_datadir, 't1000_monthly.nc'),
    'r250':os.path.join(cmip6_85_datadir, 'r250_monthly.nc'),
    'r500':os.path.join(cmip6_85_datadir, 'r500_monthly.nc'),
    'r700':os.path.join(cmip6_85_datadir, 'r700_monthly.nc'),
    'r850':os.path.join(cmip6_85_datadir, 'r850_monthly.nc'),
    'r1000':os.path.join(cmip6_85_datadir, 'r1000_monthly.nc'),
    'u250':os.path.join(cmip6_85_datadir, 'u250_monthly.nc'),
    'u500':os.path.join(cmip6_85_datadir, 'u500_monthly.nc'),
    'u700':os.path.join(cmip6_85_datadir, 'u700_monthly.nc'),
    'u850':os.path.join(cmip6_85_datadir, 'u850_monthly.nc'),
    'u1000':os.path.join(cmip6_85_datadir, 'u1000_monthly.nc'),
    'v250':os.path.join(cmip6_85_datadir, 'v250_monthly.nc'),
    'v500':os.path.join(cmip6_85_datadir, 'v500_monthly.nc'),
    'v700':os.path.join(cmip6_85_datadir, 'v700_monthly.nc'),
    'v850':os.path.join(cmip6_85_datadir, 'v850_monthly.nc'),
    'v1000':os.path.join(cmip6_85_datadir, 'v1000_monthly.nc'),
    'dtd250':os.path.join(cmip6_85_datadir, 'dtd250_monthly.nc'), 
    'dtd500':os.path.join(cmip6_85_datadir, 'dtd500_monthly.nc'),
    'dtd700':os.path.join(cmip6_85_datadir, 'dtd700_monthly.nc'),
    'dtd850':os.path.join(cmip6_85_datadir, 'dtd850_monthly.nc'),
    'dtd1000':os.path.join(cmip6_85_datadir, 'dtd1000_monthly.nc')
    }, domain_name= "Africa")
