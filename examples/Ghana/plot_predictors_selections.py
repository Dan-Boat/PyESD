...
from settings import predictors
from read_data import *



# temp_datadir = "C:/Users/dboateng/Desktop/Datasets/Station/Ghana/Temperature/cdc_download_2022-03-17_13-38/processed"

# prec_datadir = "C:/Users/dboateng/Desktop/Datasets/Station/Ghana/Precipitation/cdc_download_2022-03-17_13/processed"
...
barplot(methods=selector_methods, stationnames=stationnames_prec , path_to_data=cachedir_prec, 
        xlabel="Stations", ylabel="CV RMSE", varname= "test_rmse", varname_std ="test_rmse_std",
        filename="validation_score_", ax=ax1)

barplot(methods=selector_methods, stationnames=stationnames_prec , path_to_data=cachedir_prec, 
        xlabel="Stations", ylabel="CV R²", varname= "train_r2", varname_std ="test_r2_std",
...
barplot(methods=selector_methods, stationnames=stationnames_temp , path_to_data= cachedir_temp , 
        xlabel="Stations", ylabel="CV RMSE", varname= "test_rmse", varname_std ="test_rmse_std",
        filename="validation_score_", ax=ax1)
