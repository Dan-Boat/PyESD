# -*- coding: utf-8 -*-
"""
Created on Mon Jun 19 11:25:07 2023
...
path_to_store = "C:/Users/dboateng/Desktop/Datasets/Station/Vojvodina_new/plots/final_model"
...
def model_fitting_and_predicting(station, base_estimators, cv=KFold(n_splits=10),
    ...
    model = EnsembleRegressor(estimators=regressors, cv=cv, method="Stacking", 
    ...
    store_pickle(station,  "test_score_" + "Stacking", score_test, path_to_store)
    store_csv(station, "predictions_" + "Stacking", predictions, path_to_store)
...
#station = stationnames[1]   
    model_fitting_and_predicting(station=station, base_estimators=base_estimators, 
