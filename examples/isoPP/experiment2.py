    ...
    for i in range(num_of_stations):
        ...
        if estimator == "Stacking":
            ...
            SO.set_model(variable, method=estimator, ensemble_learning=True, 
                     ...
                     predictor_dataset=ERA5Data, cv=TimeSeriesSplit(n_splits=20),
                     scoring = scoring)
        else:
            
            
            SO.set_model(variable, method=estimator, cv=TimeSeriesSplit(n_splits=20),
                         scoring = scoring)
...
if __name__ == "__main__":
    ...
    estimators = ["LassoLarsCV", "RidgeCV","ARD", "BayesianRidge","MLP", 
